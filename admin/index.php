...
<body>
    ...
    <div class="container-fluid-xl d-flex">
        ...
        <div class="content">
            ...
            <div id="tambah" class="tambahcontent m-auto p-5 collapse">
                <center>
                    <h3>Tambah Konten</h3>
                </center>
                <br>
                <form action="" method="POST" enctype="multipart/form-data">
                    <label for="gambar">Masukkan Logo:</label> <br> <input id="gambar" type="text" class="form-control"" name=" logo"><small class="form-text text-muted">File harus bertipe JPG, JPEG, PNG, dan GIF</small><br><br>
                    <label for="judul">Masukkan Judul: </label><br><input id="judul" type="text" class="form-control" name="judul"><small class="form-text text-muted">Masukkan Judul Yang Sesuai</small><br><br>
                    <label for="isi">Masukkan Isi: </label><textarea id="isi" class="form-control" name="isi" cols="10"></textarea><small class="form-text text-muted">Masukkan Isi dengan benar</small><br><br>
                    <label for="link">Masukkan Link: </label><br><input id="link" type="text" name="link" class="form-control"><small class="form-text text-muted">Masukkan Link</small><br><br><br>
                    <label><input type="submit" class="btn btn-primary" name="tambah" value="Tambah Content"></label><br>
                </form>
            </div>
        ...
        <div class="aksi bg-secondary p-1" style="position:fixed; bottom:25px; right:25px;">
            <button href="#" class="btn btn-success m-1" data-target="#tambah" data-toggle="collapse" style="background-color:lightgrey; width:50px; height:50px; border-radius:100%; border:0;">+</button><br>
            <button onclick="mode();" class="m-1" id="mode" style="background-color:black; width:50px; height:50px; border-radius:100%; border:0;"><i class="fas fa-moon fa-2x" style="color:white;"></i></button>
        </div>
    </div>
    <!-- Optional JavaScript -->
